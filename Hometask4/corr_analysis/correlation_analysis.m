...
stream_length_1 = length(Bit_Stream_1);
stream_length_2 = length(Bit_Stream_2);

xcorr_gold = xcorr_another(gold_seq, Bit_Stream_1, stream_length_1);
xcorr_m = xcorr_another(m_seq, Bit_Stream_2, stream_length_2);

[Data_Length_1, Frame_Length_1, Start_Of_Frame_Position_1, Number_Of_Frames_1] = headers(xcorr_gold, len);
[Data_Length_2, Frame_Length_2, Start_Of_Frame_Position_2, Number_Of_Frames_2] = headers(xcorr_m, len);
